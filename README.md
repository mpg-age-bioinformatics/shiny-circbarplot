...
```bash
cd ~/shiny
git submodule init cirbarplot 
git submodule update cirbarplot 
```
Start the container:
```bash
...
--name shiny shiny
```
Access the app on your browser over [http://localhost:3838/cirbarplot](http://localhost:3838/cirbarplot).
